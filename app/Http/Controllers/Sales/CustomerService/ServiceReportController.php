...
////////////////////////////////////////////
	// update unapproved
	public function updateunapprove(Request $request)
	{
		print_r($request->all());

		if($request->has('approved_by')) {
			foreach($request->only('approved_by') as $val) {
				ICSServiceReport::where('id', $val)->update(['approved_by' => \Auth::user()->belongtostaff->id]);
			}
		}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public function updatesendSR(Request $request, ICSServiceReport $serviceReport)
	{
