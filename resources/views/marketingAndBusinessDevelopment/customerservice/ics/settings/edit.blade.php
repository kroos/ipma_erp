...
{!! Form::model( $srConstant, ['route' => ['srConstant.update', $srConstant->id], 'method' => 'PATCH', 'id' => 'form', 'files' => true]) !!}
	@include('marketingAndBusinessDevelopment.customerservice.ics.settings._edit')
{!! Form::close() !!}
			</div>
		</div>
